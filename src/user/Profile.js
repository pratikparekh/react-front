...
class Profile extends Component {
	...
	.then(data =>{
		if(data.error){
			...
			//console.log("FOLLOWID",this.state.user._id);		
		}
	})
	}
			...
			<div className = "container">
				...
				<div className="row">
					<div className="col-md-4">
						...
						<img style={{height:"200px",width:"auto"}} className = "thumb-nail" src={photoUrl} onError={i=>(i.target.src=`${DefaultProfile}`)} alt={user.name}/>
